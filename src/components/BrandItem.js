    ...
    if (loading)
        ...
        return (
            <Box w={"49%"} mr={2} mb={2} p={2} backgroundColor="#f7f7f7" overflow={"hidden"} rounded="lg" >
                ...
                >
                    <Stack space={2}>
                        <Image mt={1} h={120} w={"100%"} source={item.brand_image ? { uri: img_url + item.brand_image } : require("../../assets/placeholder.png")} alt="Image Here" resizeMode='contain' />
                        {item.brand_name ?
