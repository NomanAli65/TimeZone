...
class index extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <AppBar title={"TIMEZONE"} back noCart noWish />
        <SearchBar
          onFilterPress={() =>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getAllColors: (callback, id) =>
    dispatch(ProductMiddleware.getAllColors(callback, id)),
  getAllFilters: (callback, id) =>
    dispatch(ProductMiddleware.getAllFitlers(callback, id)),
});
