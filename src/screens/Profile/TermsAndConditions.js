            ...
            <View flex={1} backgroundColor="white" _dark={{ backgroundColor: "black" }}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    ...
                    <Text m={5} fontSize="md">
                        ...
                        Kindly note that your order could be subjected to additional verification of address or product availability.
                        {"\n\n"}
                        At any step if you need additional information , you can get in touch with our Customer Support Expert.After the verification of your order a confirmation email will be sent to your registered email address.
                        {"\n\n"}
