import { Button, FormControl, HStack, Input, InputGroup, InputLeftAddon, Pressable, ScrollView, Select, Text, View, VStack } from 'native-base';
...
class PersonalDetail extends Component {
    ...
    onPress = () => {
        ...
        let { images, model, price, condition, box_paper, comments, brand, name } = this.props.navigation.route.params;
                        ...
                        <FormControl isInvalid={this.state.invalid}>
                            <VStack space={5}>
                                ...
                                <InputGroup>
                                    ...
                                    <Input flex={1} placeholder={"1234567799"} onChangeText={(phone) => this.setState({ phone, invalid: "" })} />
                                </InputGroup>
                                {/* </HStack> */}
                            </VStack>
